            ...
            <div class="topform">
                ...
                >
                    <div class="top1">
                        ...
                        <el-form-item label="参加时间 :" prop="callDate">
                            <el-date-picker
            ...
            <template v-for="(item, index) in labelList">
                ...
                >
                    <template slot-scope="scope">
                        <span v-if="item.name == 'meetingRole'">
                            {{scope.row['meetingRole'] | filterMeeting}}
                        </span>
...
export default {
    ...
    data() {
        return {
            ...
            actionImport:
                ...
                "/excelImport/meetingExcelAttendanceImport",
            labelList: [
                {
                    label: "序号",
                    name: "id",
    ...
    methods: {
        ...
        submitForm() {
            ...
            let param = {};
            param = {
                customerCod: this.formInline.docName || null,
        ...
        //下载模板
        download() {
            window.open("static/excels/attendMetting.xlsx", "_blank");
        },
        handkeyword() {
